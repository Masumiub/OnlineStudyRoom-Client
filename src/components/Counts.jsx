                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                    <Fade cascade>
                        <div className='p-15 bg-base-200 rounded-2xl shadow-lg'>
                            ...
                            <h1 className='text-2xl lg:text-5xl mt-3 text-violet-500'> <CountUp end={9932} />+ </h1>
                            <p className='mt-2'>Assignments</p>
                        </div>

                        <div className='p-15 bg-base-200 rounded-2xl shadow-lg'>
                            <img width="48" height="48" src="https://img.icons8.com/3d-fluency/94/category.png" alt="category" />
                            <h1 className='text-2xl lg:text-5xl mt-3 text-violet-500'> <CountUp end={542} />+ </h1>
                        ...
                        <div className='p-15 bg-base-200 rounded-2xl shadow-lg'>
                            ...
                            <h1 className='text-2xl lg:text-5xl mt-3 text-violet-500'> <CountUp end={6335} />+ </h1>
                            <p className='mt-2'>Students</p>
                        </div>

                        <div className='p-15 bg-base-200 rounded-2xl shadow-lg'>
                            <img width="48" height="48" src="https://img.icons8.com/3d-fluency/94/book-shelf.png" alt="book-shelf" />
                            <h1 className='text-2xl lg:text-5xl mt-3 text-violet-500'> <CountUp end={454} />+ </h1>
