        ...
        <div>
            ...
            {/* <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-3 gap-3 items-stretch'>
                <Fade cascade triggerOnce>
                    <div className='px-10 py-18 rounded-2xl shadow-md text-white bg-gradient-to-r from-blue-600 to-violet-600 flex flex-col h-full'>
                    ...
                    <div className='px-10 py-18 rounded-2xl shadow-md text-white bg-gradient-to-r from-purple-500 to-purple-900 flex flex-col h-full'>
                    ...
                    <div className='px-10 py-18 rounded-2xl shadow-md text-white bg-gradient-to-r from-fuchsia-600 to-pink-600 flex flex-col h-full'>
                    ...
                    <div className='px-10 py-18 rounded-2xl shadow-md text-white bg-gradient-to-r from-fuchsia-600 to-purple-600 flex flex-col h-full'>
                    ...
                    <div className='px-10 py-18 rounded-2xl shadow-md text-white bg-gradient-to-r from-violet-600 to-indigo-600 flex flex-col h-full'>
                    ...
                    <div className='px-10 py-18 rounded-2xl shadow-md text-white bg-gradient-to-r from-indigo-500 to-rose-500 flex flex-col h-full'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-3 gap-3 items-stretch'>
                <Fade cascade triggerOnce>
                    <div className='px-10 py-18 rounded-2xl shadow-lg  flex flex-col h-full'>
                        <img src={assignmentPic} alt="assignmentPic" className='w-16 h-16 mb-3 object-contain' />
                        <h3 className='text-xl font-semibold'>Collaborative Assignment</h3>
                        <p className='mt-3 text-xs flex-grow'>
                            Easily create assignments that your friends can attempt. Customize topics, instructions, and deadlines to suit your study group’s needs.
                    ...
                    <div className='px-10 py-18 rounded-2xl shadow-lg   flex-col h-full'>
                        <img src={peerPic} alt="assignmentPic" className='w-16 h-16 mb-3 object-contain' />
                        <h3 className='text-xl font-semibold'>Peer-to-Peer Grading</h3>
                        <p className='mt-3 text-xs flex-grow'>
                            Review and grade your friends’ submissions with transparency. Get valuable feedback on your own work while helping others improve.
